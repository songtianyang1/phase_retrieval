...
mixedsig=A*sig; %混合信号为一个 3*65535 的矩阵
...
%显示混合图像
figure(2)
subplot(131),imshow(MI1),title( ' 混合图片 1' );
subplot(132),imshow(MI2),title( ' 混合图片 2' );
subplot(133),imshow(MI3),title( ' 混合图片 3' );
...
%显示分离后的图像
figure(3)
subplot(131),imshow(II1),title( ' 分 离 出 的 图 片1' );%,subplot(322),imhist(II1),title( ' 分离图片 1的直方图 ' );
subplot(132),imshow(II2),title( ' 分 离 出 的 图 片2' );%,subplot(324),imhist(II2),title( ' 分离图片 2的直方图 ' );
